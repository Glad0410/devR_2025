...
library(dplyr)
library(tidyr)
barometre_sncf_2019 <- read_excel("D:/LPSIG/R/data/barometre_sncf_2019.xlsx")
...
write.csv2(resultat_csv, "D:/LPSIG/R/travail/resultat.csv", row.names = FALSE)
...
ggsave("D:/LPSIG/R/travail/donnees_graph.png")
```
